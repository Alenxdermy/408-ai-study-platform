...
import { StaticPdfController } from './static-pdf.controller.js';
...
resourceRouter.get('/static-pdfs/:group/:file/preview', asyncHandler(StaticPdfController.preview));
resourceRouter.get('/static-pdfs/:group/:file/download', asyncHandler(StaticPdfController.download));
